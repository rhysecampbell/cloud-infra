...
COPY data_value (value_id, sensor_id, creationtime, nvalue, status, lane_no, sensor_no, stn_id, created, nvalue_str, forecast_created) FROM stdin;
\.
...
SELECT pg_catalog.setval('sensor_identity_sensor_id_seq1', 405946, true);
...
SELECT pg_catalog.setval('seq_data_value_id', 2727900929, true);
...
SELECT pg_catalog.setval('station_identity_stn_id_seq1', 28589, false);
